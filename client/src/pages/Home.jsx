...
const Home = () => {
    ...
    const reviews = [
        { text: 'Absolutely thrilled with my purchase! The product exceeded my expectations in terms of quality and performance. It is a game-changer, I cannot recommed Vanity enough!', author: 'John Smith', image: './src/assets/People/middleagedman.png'},
        { text: 'I was skeptical at first, but this service is a lifesaver. Lightning-fast delivery and top-notch customer support. I will be a loyal customer for years to come', author: 'Sarah Johnson', image: './src/assets/People/olderwoman.png'},
        { text: 'This company knows how to treat its customers right. The staff is incredibly knowledgeable and always ready to assist. I am impressed by their commitment to excellence.', author: 'David Wilson', image: './src/assets/People/youngwoman.png'},
        { text: 'The website is user-friendly, and the selection is outstanding. I found exactly what I needed quickly and easily. A fantastic online shopping experience!', author: 'Emily Davis', image: './src/assets/People/youngwoman.png'},
        { text: 'I cannot get enough of their products. The quality is unmatched, and the prices are very competitive. I have recommended this store to all my friends.', author: 'Michael Anderson', image: './src/assets/People/youngwoman.png'},
        { text: 'Shipping was faster than expected, and the packaging was secure. Everything arrived in perfect condition. I am one happy customer.', author: 'Jessica Brown', image: './src/assets/People/youngwoman.png'},
    ];
    ...
    return (
        <AnimatePresence>
            ...
            <section id="review-caroussel" className="flex w-screen bg-[#673ab7] h-auto py-12 px-8">
                <ReviewCarousel reviews={reviews} />
            </section>

            {/* Partners Section */}

            <section id="our-partners" className="flex flex-col justify-center items-center text-center bg-[#081016] px-8 py-14  w-full h-auto gap-y-8">
                <div id="our-partners__header" className="flex flex-col text-2xl font-semibold">
                    <span>Backed by</span>
                    <span>Amazing people</span>
                </div>
                <div id="our-partners__logo-wrapper" className="flex flex-row justify-center items-center w-full h-auto gap-x-4">
